...
authcookie = Office365('https://mytrinityhealth.sharepoint.com/', 
                       username=userInfo['username'], 
                       password=userInfo['password']).GetCookies()
site = Site('https://mytrinityhealth.sharepoint.com/sites/JFCCTherapistsTHO365',
...
#     authcookie = Office365('https://mytrinityhealth.sharepoint.com/', username=userInfo['username'], password=userInfo['password']).GetCookies()
#     site = Site('https://mytrinityhealth.sharepoint.com/sites/JFCCTherapistsTHO365', authcookie=authcookie)
#     listName='TxTimeOutDates'
#     sp_list = site.List(listName)
